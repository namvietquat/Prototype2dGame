...
public class PlayerController : AgentController
{
    ...
    public PlayerStateBase RunState;
    public PlayerStateBase JumpState;
    public PlayerStateBase FallState;
    public PlayerStateBase WallSlideState;
    public PlayerStateBase BasicAttackState;
    #endregion
